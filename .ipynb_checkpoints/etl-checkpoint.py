...
def process_log_file(cur, filepath):
    ...
    It extracts the ts (time serial) information in order to store it into the time table.
    Then it extracts the user information in order to store it into the users table.
    After that it will extract some columns from both users, duration and atrist tables in order to insert it
    to the songs play table.
...
def process_data(cur, conn, filepath, func):
    ...
    * filepath the file path to the song file.
    * func a function for processing the data.
    """
